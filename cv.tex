...
\begin{resume}
    ...
    \section{\mysidestyle Honors and\\Awards} 
                Data Science Fellowship, Berkeley Institute for Data Science.      \hfill \textbf{2014--2016}\vspace{.5mm}\\%
    ...
    \section{\mysidestyle Books}
      \begin{bibenum}
       \item \textbf{Huff, K.}, Scopatz A. ``A Field Guide For Computational 
         Physics.'' Under contract with O'Reilly Media. 2014. 
      \end{bibenum}
    %__________________________________________________________________________________________________________________
