...
\begin{resume}
    ...
    \begin{bibenum}
      \item Huff, K., Nutt, W.M. ``FY12 Sensitivity Studies Using the UFD Clay Generic Disposal System Model.'' 
        \emph{Argonne National Laboratory}. (FCRD-USED-2012-000141). July 2012.
    ...
    \textbf{Scientific Computing Workshop}, Berkeley, CA \hfill [Upcoming] \textbf{Oct 27--28, 2012}\\
               \textbf{Invited By : } University of California, Berkeley, Dept. of Statistics\\
               \textsl{Lecturer}\\
               UNIX Shell, Version Control, Databases, Python

    \textbf{Software Carpentry Python Workshop}, Berkeley, CA \hfill [Upcoming] \textbf{Oct 24--25, 2012}\\
