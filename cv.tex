...
\begin{resume}
    ...
    %\section{\mysidestyle Refereed\\Journal\\Publications} % also, vspace below
      \begin{bibenum}
        \item \textbf{Huff, K.}, \textbf{Nutt, W.}. ``Key Processes and 
          Parameters in a Generic Clay Disposal System Model'' \emph{Submitted}, 
          2013.
        \item Aruliah,~D.A., Brown,~C.T., Chue Hong,~N.P., Davis,~M., Guy,~R.T., 
          ...
          Scientific Computing.''  \emph{Accepted} \textsl{PLOS Biology}, 2013. 
