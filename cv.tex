...
\begin{resume}
    ...
    %  \begin{bibenum}
    %  \textbf{Huff, K.}, Scopatz A. ``Effective Computation in Physics.'' Under contract with O'Reilly Media. November 2014. 
    %  \end{bibenum}
    %__________________________________________________________________________________________________________________
...
http://dx.doi.org/10.6084/m9.figshare.1041829. June 2014.
    ...
    \section{\mysidestyle Professional\\Service}
		\textbf{Board Member}, Software Carpentry. \hfill \textbf{2014--present}\vspace{.5mm}\\%
