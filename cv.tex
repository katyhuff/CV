...
\nobibliography{cv}
    ...
    \section{\mysidestyle Books}
      \begin{bibenum}
      Scopatz, A., \item \textbf{Huff, K.}. ``Effective Computation in 
      Physics.'' (in review.) O'Reilly Media. 2015. 
      \end{bibenum}
    %__________________________________________________________________________________________________________________
...
http://dx.doi.org/10.6084/m9.figshare.1041829. June 2014.
    ...
    \section{\mysidestyle Professional\\Service}
		\textbf{Founding Board Member}, Software Carpentry Foundation.  \hfill \textbf{2014--2015}\vspace{.5mm}\\%
