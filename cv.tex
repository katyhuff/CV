...
\begin{resume}
    ...
    Assistant Professor, \textsl{University of Illinois, Urbana-Champaign} \hfill mobile: (281) 734-1342           \vspace{0mm}\\\vspace{0mm}%
    \textsl{Nuclear, Plasma, and Radiological Engineering}       \hfill e-mail: katyhuff@gmail.com            \vspace{0mm}\\\vspace{0mm}%
    \textsl{National Center for Supercomputing Applications}           \hfill website: katyhuff.github.com     \vspace{0mm}\\\vspace{-4.5mm}%
    ...
    \begin{bibenum}
      \item Bae, J. W., \textbf{Huff, K.}, Bae, J.W., Flanagan, R., Scopatz, A.
              ``Current Status of Demand Driven Deployment in Fuel Cycle 
              Simulation''
              Paper XXXX.  \textbf{GLOBAL International Fuel Cycle Conference}, 
              Seoul, North Korea. September 2017. 
      \item Bae, J. W., \textbf{Huff, K.}, Roy, W. 
              ``Benefits of Siting a Borehole Repository on Non-Operating 
              Nuclear Facility''
            Paper XXXXX.  \textbf{International High Level Radioactive Waste 
            Management Conference (IHLRWM2017)},
 ...
 \end{bibenum}
    ...
    \textbf{SciPy}, Scientific Python Conference, \emph{Keynote}.  \hfill\textbf{Jul ??, 2017}\\
    \textbf{PyCon}, Python Conference, \emph{Keynote}.  \hfill\textbf{May 19, 2017}\\
    \textbf{UC Davis}, Mechanical \& Aerospace Engineering, \emph{Graduate Seminar}.  \hfill\textbf{Apr 20, 2017}\\
    ...
    \textbf{UC Berkeley}, Practice of Reproducible Research Symposium, \emph{Lightning Talk}.  \hfill\textbf{Jan 27, 2017}\\
    \textbf{U. Illinois}, Informatics, \emph{Seminar}.  \hfill\textbf{Oct 13, 2016}\\
    \textbf{PyData}, Chicago, \emph{Keynote}.  \hfill\textbf{Aug 27, 2016}\\
    \textbf{ORNL}, Reactor Physics and Nuclear Science Division, \emph{Seminar}.  \hfill\textbf{Mar 3, 2016}\\
    \textbf{U. Tennessee}, Nuclear Engineering, \emph{Seminar}.  \hfill\textbf{Mar 2, 2016}\\
    ...
    \textbf{Manuscript Referee} \hfill \emph{Nuclear Engineering and Design}\\%
                            \mbox{}~\hfill\emph{Progress in Nuclear Energy}\\%
                            \mbox{}~\hfill\emph{Nuclear Science and Engineering}\\%
                            \mbox{}~\hfill \emph{Journal of Nuclear Energy Science and Power Generation Technology}\vspace{2mm}\\%
    ...
    \textbf{Book Proposal Referee} \hfill\emph{O'Reilly Media}\vspace{2mm}\\%
