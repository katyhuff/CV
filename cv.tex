...
\begin{resume}
    ...
    \textbf{Computer Literacy Workshop}, Chicago, IL \hfill \textbf{Jan 12--13, 2013}\\
    ...
    %\section{\mysidestyle Refereed\\Journal\\Publications} % also, vspace below
      \begin{bibenum}
        \item Aruliah,~D.A., Brown,~C.T., Chue Hong,~N.P., Davis,~M., Guy,~R.T., 
          ...
          Scientific Computing.''  \emph{Submitted,} arXiv:1210.0530 
          [cs.MS].
    ...
    \begin{bibenum}
      \item \textbf{Huff K.} ``Hydrologic Nuclide Transport Models in Cyder, a Geologic Disposal Software Library.''
         \emph{Proceedings of the Waste Management Symposium.}
      ...
      \item \textbf{Huff K.}, Oliver, K., Wilson, P.P.H. ``GENIUSv2 Discrete Facilities/Materials Modeling of International 
        ...
        % [paper][talk]
      \item Oliver, K.M., Wilson, P.P.H., Reveillere, A., \textbf{Huff K.} ``Studying 
    ...
    \section{\mysidestyle Professional\\and Student\\Organizations} 
		\textbf{Secretary--Treasurer (nominated)}, Fuel Cycle \& Waste Management Division, ANS. \hfill \textbf{2013--2015}\vspace{.5mm}\\%
		\textbf{Secretary (nominated)}, Young Members Group, ANS. \hfill \textbf{2013--2014}\vspace{.5mm}\\%
